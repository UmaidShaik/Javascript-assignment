...
//  let admin = User.newAdmin("Umaid", "Male", 22) 
//  let user = admin.newUser('Shaikh','Male',22)
//  let user1 = admin.newUser('Siddhi','Female',22)
//  admin.updateUser(1,"fullName","Umaid")
//  admin.deleteUser(2)

let adminObj = User.newAdmin("Umaid", "Male", 22)
let user1=adminObj.newUser("Shaikh",'Male',22)
let user2=adminObj.newUser('Siddhi','Female',22)//
let user3=adminObj.newUser("Rahul", 'male', 25)//
user1.createContact("Umaid","India")
user1.createContactInfo(0,"Email","Umaid@gmail.com")//

user1.createContact("Shaikh","India")
user1.createContactInfo(1,"Email","Shaikh@gmail.com")//
let updatedContact = user1.updateContact(0, "contactName", "rahul");
